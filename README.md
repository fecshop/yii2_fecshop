...
**因为之前想吧这个做成saas的方式做点创收，后面想直接开源了，因此来回折腾了一番，fecshop中已经默认打点，通过配置开启就行下面的文档和文档需要进一步的理（文档的一些），有兴趣的可以看看下面demo（不要修改密码）。近期个人时间太少，2018.10月中旬的时候在整理该功能，目前文档和功能需要进一步梳理**
