	 ...
	 *  1. 生成图片，
		...
		2. 访问图片：
			<p>
				...
				<img  title="点击刷新" src="http://fecshop.appfront.fancyecommerce.com/site/helper/captcha" align="absbottom" onclick="this.src='captcha.php?'+Math.random();"></img>
			</p>
		3. 验证：验证成功返回true 失败返回false
		$code = ''  // code是用户传递过来的值。
