			...
			<div class="payment-methods">
				<dl id="checkout-payment-method-load">
					<?php  if(is_array($payments) && !empty($payments)){  ?>
						...
						<?= $info['style'];  ?>	
						<dt>
							<input style="display:inline" id="p_method_<?= $payment ?>" value="<?= $payment ?>" name="payment[method]" title="<?= $info['label']; ?>" class="radio validate-one-required-by-name" <?=  ($current_payment_mothod == $payment) ? 'checked="checked"' : '' ; ?> type="radio">
