		...
		<li>
			<div>
				<select name="address_id" class="address_list">
					<option selected="true;" value="1608"> firstname lastname fdaf@dasfasd.com 32423432432 street2 street1 city state Turks and Caicos Islands </option>
