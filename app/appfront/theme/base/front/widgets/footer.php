					...
					<div class="container">
						<div class="row">
							...
							<div class="col-xs-12 col-sm-6 col-md-3 widget links">
								...
								<nav>
									<ul>
										<li class="first"><a href="http://www.intosmile.com/about-us" title="About us" rel="nofollow"><?= Yii::$service->page->translate->__('About Us'); ?></a></li>
										<li><a href="http://www.intosmile.com/privacy-policy" title="Privacy Policy" rel="nofollow"><?= Yii::$service->page->translate->__('Privacy Policy'); ?></a></li>
										<li><a href="http://www.intosmile.com/return-policy" title="Return Policy" rel="nofollow"><?= Yii::$service->page->translate->__('Return Policy'); ?></a></li>
										<li><a href="http://www.intosmile.com/faq" title="FAQ" rel="nofollow"><?= Yii::$service->page->translate->__('FAQ'); ?></a></li>
										<li class=" last"><a href="http://www.intosmile.com/contacts" title="Contact Us" rel="nofollow"><?= Yii::$service->page->translate->__('Contact Us'); ?></a></li>
									</ul>
								</nav>
							</div>
							<div class="col-xs-12 col-sm-6 col-md-3 newsletter widget links">
								...
								<ul>
									<li><a href="http://www.intosmile.com/customer/account/index" rel="nofollow"><?= Yii::$service->page->translate->__('My Account'); ?></a></li>
									<li><a href="http://www.intosmile.com/customer/order" rel="nofollow"><?= Yii::$service->page->translate->__('My Order'); ?></a></li>
									<li><a href="http://www.intosmile.com/customer/account/productreview" rel="nofollow"><?= Yii::$service->page->translate->__('My Reviews'); ?></a></li>
									<li><a href="http://www.intosmile.com/favorite/product" rel="nofollow"><?= Yii::$service->page->translate->__('My Favorite'); ?></a></li>
									<li><a href="http://www.intosmile.com/sitemap.xml"><?= Yii::$service->page->translate->__('Site Map'); ?></a></li>
								</ul>
							</div>
							<div class="clear"></div>
						</div>
