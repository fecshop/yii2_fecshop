...
namespace fecshop\app\appadmin\modules\Config\block\appserveraccount;
...
class Manager extends AppadminbaseBlockEdit implements AppadminbaseBlockEditInterface
{
    ...
    public function init()
    {
         ...
         // 需要配置
        $this->_saveUrl = CUrl::getUrl('config/appserveraccount/managersave');
