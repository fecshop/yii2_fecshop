...
namespace fecshop\app\appadmin\modules\Config\block\cart;
...
class Manager extends AppadminbaseBlockEdit implements AppadminbaseBlockEditInterface
{
    ...
    public function init()
    {
         ...
         // 需要配置
        $this->_saveUrl = CUrl::getUrl('config/cart/managersave');
    ...
    public function getEditArr()
    {
        ...
        return [
            // 需要配置
            [
                'label' => Yii::$service->page->translate->__('addToCartCheckSkuQty'),
                'name'  => 'addToCartCheckSkuQty',
                'display' => [
                    'type' => 'select',
                    'data' => [
                ...
                'remark' => '商品加入购物车，进行产品的库存检查，建议配置NO，无库存商品可以加入购物车，但是不能下单'
            ],
            
            
            [
                'label'  => Yii::$service->page->translate->__('maxCountAddToCart'),
                'name' => 'maxCountAddToCart',
                'display' => [
                    'type' => 'inputString',
                ],
                'remark' => '单个商品sku加入购物车的最大个数，增加恶意下单占用商品库存的难度',
            ],
