...
namespace fecshop\app\appadmin\modules\Config\block\apphtml5account;
...
class Manager extends AppadminbaseBlockEdit implements AppadminbaseBlockEditInterface
{
    ...
    public function init()
    {
         ...
         // 需要配置
        $this->_saveUrl = CUrl::getUrl('config/apphtml5account/managersave');
