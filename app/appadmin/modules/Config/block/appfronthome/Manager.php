...
namespace fecshop\app\appadmin\modules\Config\block\appfronthome;
...
class Manager extends AppadminbaseBlockEdit implements AppadminbaseBlockEditInterface
{
    ...
    public function init()
    {
         ...
         // 需要配置
        $this->_saveUrl = CUrl::getUrl('config/appfronthome/managersave');
    ...
    public function getEditArr()
    {
        ...
        return [
            ...
            [
                'label'  => Yii::$service->page->translate->__('Best Seller Sku'),
                'name' => 'best_seller_sku',
                'display' => [
                    'type' => 'inputString',
                ],
                'remark' => '',
