 ...
 * @since 1.0
 */
class Managerbatch extends AppadminbaseBlockEdit implements AppadminbaseBlockEditInterface
{
    public $_importUrl;
    protected $_attr;
    ...
    public function init()
    {
        ...
        $this->_importUrl = CUrl::getUrl('catalog/productinfo/managerbatchimport');
        parent::init();
